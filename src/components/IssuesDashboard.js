...
class IssuesDashboard extends Component {
  ...
  handleRefresh = () => {
    ...
    this.props.dispatch(
      handleReceiveIssues(page, limit, this.state.searchParams)
    );
  };
    ...
    return (
      ...
      (issues && issues.length > 0 ? (
        <h3 className="text-center mt-3">
          No issues found. Try again later...
          <button className="btn btn-light" onClick={this.handleRefresh}>
        ...
        <div>
          ...
          <div className="card mb-3">
            <div className="card-header">
              ...
              <span className="h5 project-name">{project}</span>
              <button
